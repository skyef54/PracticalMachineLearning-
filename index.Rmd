...
Number of predictors dropped because of near zero-variance is `r length(nzv)` and by the reason of high correlation is `r length(highCorr)`. The reduction steps could shrink the dimension from `r ncol(testing2)-1` to `r ncol(training2)-1` features.
...
Model training time with **parallel** is 1306.57 seconds and 4000 seconds without multiprocessors.
